...
<head>
    <meta charset="UTF-8">
    <title>Certificate of Graduation</title>
    <style>
...
<div class="page">
    ...
    <p class="body-text">
        ...
        was a graduate of Clark College of Science and Technology during the school year. 
        He graduated with the track and strand <span class="blank">&nbsp;&nbsp;{{ $strand }}&nbsp;&nbsp;</span>
        last <span class="blank">&nbsp;&nbsp;{{ $school_year }}&nbsp;&nbsp;</span> 
        with the recommendation and approval of Department of Education, with the given special-order number 
        of <span class="blank">&nbsp;&nbsp;__________&nbsp;&nbsp;</span> series of 2025.
    </p>

    <p class="body-text">
        This certification is issued upon the request of <span class="blank">&nbsp;&nbsp;{{ $student_name }}&nbsp;&nbsp;</span>
        for any legal purpose(s) that may serve him.
    </p>
    ...
    <div class="form-number">CCSTSHS FORM-011</div>
</div>
</body>
</html>
