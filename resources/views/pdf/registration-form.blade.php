...
<head>
    <meta charset="UTF-8">
    <title>Registration Form (REG)</title>
    <style>
...
<div class="page">
    ...
    <p class="body-text">
        ...
        is enrolled in this institution as a full time 
        <span class="blank">&nbsp;&nbsp;{{ $grade_level }}&nbsp;&nbsp;</span> student under 
        <strong>SENIOR HIGH SCHOOL DEPARTMENT</strong> with the course 
        <span class="blank">&nbsp;&nbsp;{{ $strand }}&nbsp;&nbsp;</span> 
        of the {{ $semester }} of school year {{ $school_year }}.
    </p>
    ...
    <div class="form-number">CCSTSHS-001</div>
</div>
</body>
</html>
