...
<div class="page">
    ...
    <p class="body-text">
        ...
        was a bona fide student of this institution and has completed the requirements for Senior High School 
        under the strand <span class="blank">&nbsp;&nbsp;&nbsp;&nbsp;{{ $strand }}&nbsp;&nbsp;&nbsp;&nbsp;</span>
        last <span class="blank">&nbsp;&nbsp;&nbsp;&nbsp;{{ $school_year }}&nbsp;&nbsp;&nbsp;&nbsp;</span>.
    </p>

    <p class="body-text">
        This further certifies that while in our institution, he/she has maintained a good moral character 
        and has not been subjected to any disciplinary action.
    </p>

    <p class="body-text">
        Issued this <span class="blank">&nbsp;&nbsp;&nbsp;&nbsp;{{ $current_date }}&nbsp;&nbsp;&nbsp;&nbsp;</span>
        at Dau, Mabalacat City, Pampanga for any legal purpose/s that may serve him/her.
    </p>
    ...
    <div class="form-number">CCSTSHS FORM-010</div>
</div>
</body>
</html>
