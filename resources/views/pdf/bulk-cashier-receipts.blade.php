...
<head>
    <meta charset="UTF-8">
    <title>Bulk Cashier Receipts - {{ $dateLabel }}</title>
    <style>
        @page { 
            size: legal; 
            margin: 0.3in; 
        ...
        <div class="container">
            ...
            <div class="half">
                ...
                <table class="details-table">
                    <tr>
                        ...
                        <td class="value" style="font-weight: bold; color: #1565C0;">{{ $receipt['reference_number'] }}</td>
                        <td class="label" style="padding-left: 15px; width: 90px;">Appointment Date:</td>
                        <td class="value">{{ $receipt['appointment_date'] }}</td>
                    </tr>
                    <tr>
                        <td class="label">Student Name:</td>
                        <td class="value">{{ strtoupper($receipt['student_name']) }}</td>
                        <td class="label" style="padding-left: 15px; width: 90px;">Student Number:</td>
                        <td class="value">{{ $receipt['student_number'] }}</td>
                    </tr>
                    <tr>
                        <td class="label">Appointment Time:</td>
                        <td class="value">{{ $receipt['appointment_time'] }}</td>
                        <td class="label" style="padding-left: 15px; width: 90px;">Request Type:</td>
                        <td class="value"><strong>{{ $receipt['request_type'] }}</strong></td>
                    </tr>
                </table>
                ...
                <table class="docs-table">
                    ...
                    <tbody>
                        @foreach($receipt['requested_documents'] as $doc)
                        <tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right; width: 200px;">
                            <div class="amount-box">
                                ...
                                <div class="amount-value">PHP {{ number_format($receipt['total_fee'], 2) }}</div>
                            </div>
            ...
            <div class="half">
                ...
                <table class="details-table">
                    <tr>
                        <td class="label">Reference Number:</td>
                        <td class="value" style="font-weight: bold;">{{ $receipt['reference_number'] }}</td>
                        <td class="label" style="padding-left: 15px; width: 90px;">Appointment Date:</td>
                        <td class="value">{{ $receipt['appointment_date'] }}</td>
                    </tr>
                    <tr>
