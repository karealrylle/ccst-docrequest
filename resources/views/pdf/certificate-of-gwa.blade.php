...
<head>
    <meta charset="UTF-8">
    <title>Certificate of GWA</title>
    <style>
...
<div class="page">
    ...
    <p class="body-text">
        ...
        with a <strong><span class="blank">&nbsp;&nbsp;general weighted average of {{ $general_average }}%&nbsp;&nbsp;</span></strong> 
        during her stay in our institution during grade 11 and 12, 
        <span class="blank">&nbsp;&nbsp;{{ $school_year }}&nbsp;&nbsp;</span>.
    </p>

    <p class="body-text">
        Issued this <span class="blank">&nbsp;&nbsp;{{ $current_date }}&nbsp;&nbsp;</span> 
        at Dau, Mabalacat City, Pampanga upon the request of the abovementioned name for 
        <em>scholarship purposes only.</em>
    </p>
