...
<div class="page">
    ...
    <p class="body-text">
        ...
        has completed Senior High School under the strand
        <span class="blank">&nbsp;&nbsp;&nbsp;&nbsp;{{ $strand }}&nbsp;&nbsp;&nbsp;&nbsp;</span>
        on <span class="blank">&nbsp;&nbsp;&nbsp;&nbsp;{{ $school_year }}&nbsp;&nbsp;&nbsp;&nbsp;</span>
        at Clark College of Science and Technology with the recommendation of the Department of Education.
    </p>
    ...
    <div class="form-number">CCSTSHS FORM-012</div>
</div>
</body>
</html>
